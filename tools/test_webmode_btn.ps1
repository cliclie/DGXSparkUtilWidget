...
try {
    ...
    # Locate control bar dynamically (h 24-40px app window); WebToggle = 5th button center = bar Left + 162px
    ...
    $togX = [int]($barB.Rect.Left + (162 * $S)); $togY = [int](($barB.Rect.Top + $barB.Rect.Bottom) / 2)
